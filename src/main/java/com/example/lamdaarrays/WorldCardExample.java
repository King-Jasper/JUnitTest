...
//T should either be number or it's subclasses

public class WorldCardExample<T extends Number> {
    private int [] data;
    private static int DEFAULT_SIZE = 10;
    private int size = 0;// also working as the index value

    public WorldCardExample(){
    ...
    public static void main(String [] args ){
        ...
        list3 .add(true);
        list2.add(3);
        WorldCardExample <Integer>list4 = new WorldCardExample();
        for(int i =0; i<14; i++){
            list3.add(2*i);
        }
